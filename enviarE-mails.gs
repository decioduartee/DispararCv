function realizarBackup() {
  ...
  var paginaOrigem = planilhaOrigem.getSheetByName("ListaEmail");
  ...
  var paginaOrigem2 = planilhaOrigem2.getSheetByName("Mensagem");
  ...
  var idPlanilhaDestino = "1vJ2D0DStDtroAUrjpCn-fY_xA3mbOqTxSHVbMTHiDrY"; // Substitua pelo ID da sua planilha de destino
